                ...
                <div class="card-header pb-0">
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu tx-13">
                            <a class="dropdown-item @if(request()->is('invoices/archive')) active @endif" href="{{url('invoices/archive')}}">الكل</a>
                        @foreach($statuses as $status)
                                <a class="dropdown-item @if(request()->is('invoices/' . $status->id . '/archive')) active @endif" href="{{ url('invoices/' . $status->id . '/archive') }}">
                                    {{ $status->name }}
                                </a>
                            @endforeach
                        </div>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu tx-13">
                                                ...
                                                <a class="dropdown-item"
                                                   href="{{route('invoices.restore' , $invoice->id)}}"><i class="text-warning fas fa-exchange-alt"></i> استرجاع الفاتورة</a>



                                                <a class="dropdown-item" href="{{ $invoice->id }}/print"><i
...
@section('js')
    ...
    <script>
        ...
        $('#delete_invoice').on('show.bs.modal', function(event) {
            ...
            var newActionUrl = '{{ route('invoices.delete', '') }}' + '/' + invoice_id; // Construct the new action URL
