...
{{--// Toggle the light and dark layouts--}}
{{--document.querySelector('.light-layout').style.display = document.querySelector('.light-layout').style.display === 'none' ? 'inline' : 'none';--}}
{{--document.querySelector('.dark-layout').style.display = document.querySelector('.dark-layout').style.display === 'none' ? 'inline' : 'none';--}}
